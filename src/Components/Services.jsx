            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                {
                    services_data.map((service, i) => (
                        <>
                            <div key={i} className="card  bg-base-100 card-md shadow-lg hover:scale-105 transition-transform duration-300">
                                <div className="card-body ">
                                    <div className="flex flex-col gap-3 justify-center items-center mb-2">
                                        <img src={service.img_src} alt="card_img" className="w-14 rounded-full" />
